...
public class DepositFundsController {
  ...
  public ResponseEntity<BaseResponse> depositFunds(@PathVariable(value = "id") String id,
    ...
    try {
      ...
      String message = "Deposit funds request completed successfully!";
      ...
      var safeErrorMessage =
          MessageFormat.format("Error while processing request to deposit funds bank account with id - {0}", id);
