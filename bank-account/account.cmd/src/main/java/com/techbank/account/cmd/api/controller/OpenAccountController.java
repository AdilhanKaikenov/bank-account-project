...
public class OpenAccountController {
  ...
  public ResponseEntity<BaseResponse> openAccount(@RequestBody OpenAccountCommand command) {
    ...
    try {
      ...
      String message = "Bank account creation request completed successfully.";
      var openAccountResponse = new OpenAccountResponse(message, id);
      ...
      var safeErrorMessage =
          MessageFormat.format("Error while processing request to open a new bank account for id - {0}", id);
